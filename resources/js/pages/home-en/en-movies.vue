      ...
      <div class="max-w-[1600px] mx-auto px-4 md:px-6 py-8 space-y-8">
        ...
        <div class="flex flex-col gap-6 md:flex-row md:items-center md:justify-between">
            <div class="flex items-center gap-3">
                ...
                <div>
                    <h2 class="text-2xl font-bold text-gray-900 dark:text-white">Movie List</h2>
                    <p class="text-sm text-gray-500 dark:text-gray-400">Browse the latest and greatest anime movies</p>
                </div>
            </div>
